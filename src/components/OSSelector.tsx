...
const getOSLogoPath = (osId: string): string => {
  const logoPaths: { [key: string]: string } = {
    "amzn-linux-2": "/lovable-uploads/amazon-linux.png",
    "amzn-linux-2023": "/lovable-uploads/amazon-linux.png",
    "centos-7": "/lovable-uploads/centos.png",
    "centos-8": "/lovable-uploads/centos.png",
    "debian11": "/lovable-uploads/debian.png",
    "debian12": "/lovable-uploads/debian.png",
    "ubuntu20": "/lovable-uploads/ubuntu.png",
    "ubuntu22": "/lovable-uploads/ubuntu.png",
    "ubuntu24": "/lovable-uploads/ubuntu.png",
    "windows-2019": "/lovable-uploads/windows.png",
    "windows-2022": "/lovable-uploads/windows.png"
  };

  return logoPaths[osId] || "/lovable-uploads/placeholder.png";
};
...
const OSSelector = ({ value, onChange }: OSSelectorProps) => {
  console.log("Current OS selection:", value);
  console.log("Available OS options:", osOptions.map(os => os.id));
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6 stagger-children">
        {osOptions.map((os) => (
          <div
            ...
            onClick={() => onChange(os.id as OSType)}
          >
            <div className="flex items-center">
              <div className="h-14 w-14 rounded-md flex items-center justify-center mr-4 transition-all duration-300 group-hover:bg-accent-foreground/5">
                <img src={os.logoPath} alt={`${os.name} logo`} className="h-8 w-8" />
              </div>
              <div>
